...
@Component({
  ...
  template: `
    <div class="mobile-card sm:shadow-lg sm:border sm:border-slate-200 sm:overflow-hidden">
      ...
      <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-200 sm:rounded-t-xl">
      ...
      <div class="px-4 sm:px-6 py-4 sm:py-6">
        <form [formGroup]="taskForm" (ngSubmit)="onSubmit()" class="space-y-4 sm:space-y-6">
          <!-- Main Fields Grid -->
          <div class="responsive-form-grid">
            ...
            <div>
              ...
              <div class="relative">
                <select
                  ...
                  class="btn-touch w-full px-4 py-3 text-slate-900 border border-slate-200 rounded-xl bg-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent hover:border-slate-300 transition-all duration-200 text-base sm:text-sm appearance-none cursor-pointer"
                >
            ...
            <!-- Priority Field -->
            <div>
              <label for="priority" class="block text-sm font-semibold text-slate-700 mb-2 flex items-center">
                ⚡ <span class="ml-2">Priority</span> <span class="text-red-500 ml-1">*</span>
              </label>
              <div class="relative">
                <select
                  id="priority"
            ...
            @if (isEditing) {
              <div>
                <label for="status" class="block text-sm font-semibold text-slate-700 mb-2 flex items-center">
            ...
            <div class="{{ isEditing ? '' : 'sm:col-span-1' }}">
              <label for="dueDate" class="block text-sm font-semibold text-slate-700 mb-2 flex items-center">
            ...
            @if (canAssignTasks) {
              <div class="{{ isEditing ? '' : 'sm:col-span-1' }}">
                <label for="assignedUserId" class="block text-sm font-semibold text-slate-700 mb-2 flex items-center">
                ...
                <p class="mt-1 text-xs text-slate-500">Leave empty to assign to yourself</p>
              </div>
            }
            ...
            @if (canSelectOrganization && !isEditing) {
              <div class="{{ canAssignTasks ? '' : 'sm:col-span-1' }}">
                <label for="organizationId" class="block text-sm font-semibold text-slate-700 mb-2 flex items-center">
                  🏢 <span class="ml-2">Target Organization</span>
                </label>
                <div class="relative">
                  <select
                    id="organizationId"
                ...
                <p class="mt-1 text-xs text-slate-500">Leave empty to use your organization</p>
              </div>
            }
          </div>
          ...
          <!-- Description Field -->
          <div>
            <label for="description" class="block text-sm font-semibold text-slate-700 mb-2 flex items-center">
            ...
            <div class="relative">
              <textarea
                ...
                rows="4"
                class="block w-full px-4 py-3 text-slate-900 border border-slate-200 rounded-xl bg-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent hover:border-slate-300 transition-all duration-200 text-base sm:text-sm resize-none"
          ...
          <div class="flex flex-col sm:flex-row sm:justify-end gap-3 pt-4 border-t border-gray-200">
            <button
              type="button"
              (click)="onCancel()"
              class="btn-touch order-2 sm:order-1 inline-flex items-center justify-center border border-gray-300 rounded-lg shadow-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200"
            >
            ...
            <button
              ...
              class="btn-touch order-1 sm:order-2 inline-flex items-center justify-center border border-transparent rounded-lg shadow-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
              @if (isLoading) {
